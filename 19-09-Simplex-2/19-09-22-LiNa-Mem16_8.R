...
library(transmem)
PDF <- FALSE
if (PDF) pdf("Perfiles22-09-19.pdf", height = 7/1.8, width = 9/1.8)
...
AliTimes <- list (
  T.16.8a = c(0, 1, 2, 3, 4, 5),
  T.16.8b = c(0, 1, 2, 3, 4, 5)
)
ts <- c(1, 3, 6)
#-----FACTOR DE DILUCIÓN DE LAS MUESTRAS-------------------------------------
dilutions <- list(
  Feed.16.8a  = c(2.0321/0.0501, 2.0417/0.0493, 2.0078/0.0490),
  Strip.16.8a = c(1.0451/0.3242, 1.0400/0.3239, 1.0429/0.3224),
  Feed.16.8b  = c(2.0182/0.0503, 2.0311/0.0491, 2.0186/0.0452),
  Strip.16.8b = c(1.0324/0.3214, 1.0333/0.3233, 1.0277/0.3221)
)
#-----ABSORBANCIAS DE LAS ALÍCUOTAS------------------------------------------
AliAbs <- list(
  Feed.16.8.Li.a   = c(0.306, 0.202, 0.143, 0.104, 0.077, 0.059),
  Strip.16.8.Li.a  = c(0.000, 0.102, 0.162, 0.199, 0.225, 0.241),
  Feed.16.8.Na.a   = c(0.282, 0.281, 0.287),
  Strip.16.8.Na.a  = c(0.014, 0.026, 0.050),
  Feed.16.8.Li.b   = c(0.307, 0.199, 0.140, 0.106, 0.083, 0.065),
  Strip.16.8.Li.b  = c(0.000, 0.105, 0.159, 0.193, 0.215, 0.231),
  Feed.16.8.Na.b   = c(0.295, 0.286, 0.262),
  Strip.16.8.Na.b  = c(0.011, 0.034, 0.067)
)
