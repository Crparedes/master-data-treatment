...
AliAbs <- list(
  Feed.16.7.Li.a   = c(0.308, 0.212, 0.157, 0.116, 0.090, 0.071),
  Strip.16.7.Li.a  = c(0.001, 0.095, 0.153, 0.191, 0.216, 0.234),
  Feed.16.7.Na.a   = c(0.337, 0.333, 0.333),
  Strip.16.7.Na.a  = c(0.007, 0.023, 0.040),
  Feed.16.7.Li.b   = c(0.314, 0.190, 0.128, 0.089, 0.064, 0.048),
  Strip.16.7.Li.b  = c(0.002, 0.120, 0.183, 0.218, 0.241, 0.257),
