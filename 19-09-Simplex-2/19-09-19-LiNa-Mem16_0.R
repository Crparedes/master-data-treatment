...
library(transMem)
PDF <- FALSE
if (PDF) pdf("Perfiles19-09-19.pdf", height = 7/1.8, width = 9/1.8)
...
AliTimes <- list (
  T.16.0a = c(0, 1, 2, 3, 4.25, 5),
  T.16.0b = c(0, 1, 2, 3, 4.25, 5)
)
ts <- c(1, 3, 6)
#-----FACTOR DE DILUCIÓN DE LAS MUESTRAS-------------------------------------
dilutions <- list(
  Feed.16.0a  = c(2.0251/0.0508, 2.0038/0.0507, 2.0079/0.0510),
  Strip.16.0a = c(1.0663/0.5297, 1.3356/0.4409, 1.0540/0.5284),
  Feed.16.0b  = c(2.0084/0.0508, 2.0087/0.0511, 2.0208/0.0506),
  Strip.16.0b = c(1.0619/0.5295, 1.0976/0.4796, 1.0474/0.5199)
)
#-----ABSORBANCIAS DE LAS ALÍCUOTAS------------------------------------------
AliAbs <- list(
  Feed.16.0.Li.a   = c(0.308, 0.252, 0.217, 0.190, 0.163, 0.152),
  Strip.16.0.Li.a  = c(0.000, 0.044, 0.082, 0.110, 0.135, 0.147),
  Feed.16.0.Na.a   = c(0.306, 0.308, 0.303),
  Strip.16.0.Na.a  = c(0.000, 0.014, 0.028),
  Feed.16.0.Li.b   = c(0.302, 0.211, 0.156, 0.119, 0.091, 0.077),
  Strip.16.0.Li.b  = c(0.000, 0.088, 0.143, 0.180, 0.204, 0.219),
  Feed.16.0.Na.b   = c(0.312, 0.300, 0.298),
  Strip.16.0.Na.b  = c(0.001, 0.038, 0.096)
)
