...
library(transmem)
PDF <- FALSE
if (PDF) pdf("Perfiles20-09-19B.pdf", height = 7/1.8, width = 9/1.8)
...
AliAbs <- list(
  Feed.16.11.Li.a   = rnorm(6, 0.335, 0.002),
  Strip.16.11.Li.a  = rnorm(6, 0.002, 0.002),
  Feed.16.11.Na.a   = c(0.287, 0.266, 0.268),
  Strip.16.11.Na.a  = c(0.011, 0.049, 0.082),
  Feed.16.11.Li.b   = rnorm(6, 0.335, 0.002),
  Strip.16.11.Li.b  = rnorm(6, 0.002, 0.002),
