...
library(transmem)
PDF <- FALSE
if (PDF) pdf("Perfiles25-09-19.pdf", height = 7/1.8, width = 9/1.8)
...
AliTimes <- list (
  T.16.11a = c(0, 1, 2.1, 3, 4, 5),
  T.16.11b = c(0, 1, 2.1, 3, 4, 5)
)
ts <- c(1, 3, 6)
#-----FACTOR DE DILUCIÓN DE LAS MUESTRAS-------------------------------------
dilutions <- list(
  Feed.16.11a  = c(2.0523/0.0530, 2.0380/0.0518, 2.0273/0.0491),
  Strip.16.11a = c(1.0220/0.2942, 1.0115/0.2990, 1.0319/0.2393),
  Feed.16.11b  = c(2.0585/0.0511, 2.0344/0.0506, 2.0365/0.0510),
  Strip.16.11b = c(1.0345/0.2989, 1.0335/0.2996, 1.0298/0.2969)
)
#-----ABSORBANCIAS DE LAS ALÍCUOTAS------------------------------------------
AliAbs <- list(
  Feed.16.11.Li.a   = c(0.335, 0.202, 0.118, 0.080, 0.051, 0.034),
  Strip.16.11.Li.a  = c(0.000, 0.122, 0.207, 0.242, 0.272, 0.287),
  Feed.16.11.Na.a   = c(0.287, 0.266, 0.268),
  Strip.16.11.Na.a  = c(0.011, 0.049, 0.082),
  Feed.16.11.Li.b   = c(0.332, 0.221, 0.140, 0.100, 0.072, 0.053),
  Strip.16.11.Li.b  = c(0.000, 0.093, 0.177, 0.218, 0.246, 0.267),
  Feed.16.11.Na.b   = c(0.268, 0.270, 0.271),
  Strip.16.11.Na.b  = c(0.014, 0.032, 0.061)
)
