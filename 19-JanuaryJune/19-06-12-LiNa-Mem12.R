...
#-----MUESTRAS CIEGAS--------------------------------------------------------
BlindeP <- data.frame(LiRe = c(0.4062, 0.0921, 0.2189, 0.3157, 1.4315, 1.5697, 0.9967, 0.9701) * StockLi.5_4 /
                        c(6.4381, 6.0603, 6.0808, 6.0657, 6.0402, 6.1427, 6.2846, 6.2175),
                      LiSg = c(0.043, 0.011, 0.024, 0.036, 0.162, 0.170, 0.103, 0.109),
                      NaRe = c(0.1385, 0.2696, 0.1867, 0.3856, 0.5885, 0.5897, 0.1488, 0.6064) * StockNa.600_1 /
                        c(6.4381, 6.0603, 6.0808, 6.0657, 6.0402, 6.1427, 6.2846, 6.2175),
                      NaDl = c(1.5125/0.1739, 1.4951/0.1358, 1.5241/0.1679, 1.5112/0.1543, 1.5171/0.1540,
                               1.5175/0.1541, 1.5170/0.1556, 1.5125/0.1555),
                      NaSg = c(0.310, 0.489, 0.416, 0.723, 1.000, 0.988, 0.322, 1.007))
